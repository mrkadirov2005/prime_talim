...
export default function Item_Card({ heading, data }: Props) {
  return (
    <div className="flex flex-col m-auto p-6 sm:p-8 md:p-10 h-auto sm:h-[200px] items-center justify-around bg-gradient-to-br from-[#6CA6CD] to-[#7B68EE]   w-full hover:scale-105 transition-transform rounded-md shadow-lg">
