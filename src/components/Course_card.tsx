...
export default function Course_card({name,description,price,teacher,levels,index}:PROPS) {
  return (
    <div id={`${index}`} className="w-[350px]  hover:scale-115 text-gray-950 shadow-2xl shadow-gray-950 h-fit gap-5 px-5 flex flex-col items-start justify-start min-h-[300px] bg-gradient-to-tr from-orange-400 to-gray-600 rounded-md p-2">
        ...
        <p className="w-[300px] border-b-4 border-gray-950 pb-2 h-fit text-xl text-wrap flex flex-wrap">
          Tavsifi: {description}  
        </p>
