...
export default function Class({ classs, type }: Props) {
  return (
    <div className="flex items-center justify-between hover:scale-105 transition-transform bg-gradient-to-br from-violet-400 to-[#6CA6CD] px-6 sm:px-8 py-4 sm:py-5 rounded-lg text-black w-full sm:w-[350px] md:w-[450px] lg:w-[500px] gap-3 shadow-md">
